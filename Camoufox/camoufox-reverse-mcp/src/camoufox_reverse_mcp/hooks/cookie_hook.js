// cookie_hook.js - injected helper script for camoufox-reverse-mcp
/**
...
(function () {
    ...
    window.__mcp_hook_uninstallers.cookie = function() {
        const restored = [];
        try {
            Object.defineProperty(owner, 'cookie', descriptor);
            restored.push('document.cookie');
        } catch (e) {}
        window.__mcp_cookie_hook_installed = false;
        delete window.__mcp_hook_uninstallers.cookie;
        return restored;
    };
